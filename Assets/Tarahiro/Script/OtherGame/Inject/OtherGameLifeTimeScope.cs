...
namespace Tarahiro.OtherGame.Inject
{
    public class OtherGameLifeTimeScope : LifetimeScope
    {
        ...
        {
            Log.Comment("OtherGameLifetimeScope��Register�J�n");
            //OtherGame
            builder.RegisterFactory<Sprite, IOtherGameIcon>(container =>
            {
                ...
                return sprite =>
                {
                    var prefab = UtilResource.GetResource<OtherGameIcon>("Prefab/OtherGameIcon");
            ...
            builder.RegisterFactory<IOtherGameMenuItemViewArgs, IOtherGameMenuItemView>(container =>
            {
                return args =>
                {
                    var prefab = UtilResource.GetResource<OtherGameMenuItemView>("Prefab/OtherGameMenuItemView");
